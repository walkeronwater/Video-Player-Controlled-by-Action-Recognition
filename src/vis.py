...
if __name__ == "__main__":
    ...
    visFile('DataSet/newFromRealTime/zjh323/fi5_log.csv',0)
    visFile('DataSet/newFromRealTime/zjh323/rw5_log.csv',0)
    visFile('DataSet/newFromRealTime/zjh323/lw5_log.csv',0)
    visFile('DataSet/newFromRealTime/zjh323/rr5_log.csv',0)
    visFile('DataSet/newFromRealTime/zjh323/lr5_log.csv',0)
